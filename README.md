...
When building BoredOS, the main OS build coordinator copies wallpapers from the `wallpapers/` subdirectory inside this repository directly to `/Library/images/Wallpapers/` in the target filesystem image.
